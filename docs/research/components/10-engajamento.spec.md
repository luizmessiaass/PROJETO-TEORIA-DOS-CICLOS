# Engajamento Specification

## Overview
- **Target file:** static section in `index.html` with styles in `styles.css`
- **Screenshot:** `docs/design-references/section-10-engajamento-desktop.png`
...
- Extracted selector: `div.elementor-element.elementor-element-2f341635`
...
## Assets
- assets/012-icp1-mockup-02.png (image/webp)

## Text Content (verbatim)
```text
ENGAJAMENTO Crie comunidade Ofereça aos seus membros a oportunidade de fazer publicações, interagir entre si e criar networking.
```
...
```json
{
  "tag": "div",
  "id": null,
  "classes": "elementor-element elementor-element-2f341635 e-flex e-con-boxed e-con e-parent",
  "text": null,
  "styles": {
    "fontSize": "16px",
    "fontWeight": "400",
      ...
      "children": [
        {
          "tag": "div",
          "id": null,
          "classes": "elementor-element elementor-element-4a4d2b5e e-con-full e-flex e-con e-child",
          "text": null,
          "styles": {
            "fontSize": "16px",
            "fontWeight": "400",
          ...
          "children": [
            {
              "tag": "div",
              "id": null,
              "classes": "elementor-element elementor-element-1db929e3 elementor-widget-laptop__width-inherit elementor-widget-mobile__width-inherit elementor-widget elementor-widget-heading",
              "text": null,
              "styles": {
                "fontSize": "16px",
                "fontWeight": "400",
            ...
            },
            {
              "tag": "div",
              "id": null,
              "classes": "elementor-element elementor-element-ef286d2 elementor-widget-laptop__width-inherit elementor-widget-mobile__width-inherit elementor-widget elementor-widget-heading",
              "text": null,
              "styles": {
                "fontSize": "16px",
                "fontWeight": "400",
            ...
            },
            {
              "tag": "div",
              "id": null,
              "classes": "elementor-element elementor-element-3415af7f elementor-widget-laptop__width-inherit elementor-widget-tablet__width-inherit elementor-widget elementor-widget-text-editor",
              "text": null,
              "styles": {
                "fontSize": "18px",
                "fontWeight": "500",
