...
const useResizeObserver = (
  ...
  useEffect(() => {
    ...
    const hasResizeObserver =
      typeof (window as Window & { ResizeObserver?: unknown }).ResizeObserver !==
      "undefined";
...
const useImageLoader = (
  ...
  useEffect(() => {
    const nodes = seqRef.current?.querySelectorAll("img");
    const images: HTMLImageElement[] = nodes ? Array.from(nodes) : [];
    if (images.length === 0) {
      onLoad();
      return;
    }
